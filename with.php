...
<div class="main">
    ...
    <div class="topnav">   
       ...
       <center><h1>Withdraw Your Money !!</h1></center>
    <center><h2><i>Do not save what is left after spending, but spend what is left after saving. </i></h2></center>
        <form action="tak.php" method="post">
            ...
            <label>Enter the Amount to withdraw:</label><input type="text" name="amt" placeholder=" Amount to withdraw"required /> </br></br>
